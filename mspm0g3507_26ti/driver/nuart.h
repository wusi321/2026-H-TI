...
extern volatile uint32_t g_uart1_overrun_error_count;
extern volatile uint32_t g_uart1_break_error_count;
extern volatile uint32_t g_uart1_framing_error_count;
extern volatile uint32_t g_uart1_parity_error_count;
extern volatile uint32_t g_uart1_noise_error_count;
