...
#define SPI_CLK0   DL_GPIO_clearPins(SPI0_PORT,   SPI0_SCLK_PIN)		//PA12
#define SPI_CLK1   DL_GPIO_setPins(SPI0_PORT,     SPI0_SCLK_PIN)
#define SPI_MOSI0  DL_GPIO_clearPins(SPI0_PORT,   SPI0_MOSI_PIN)		//PA14
#define SPI_MOSI1  DL_GPIO_setPins(SPI0_PORT,     SPI0_MOSI_PIN)

#define  SPI_MISO_IN (bool)((SPI0_PORT->DIN31_0 & DL_GPIO_PIN_13)==DL_GPIO_PIN_13)
