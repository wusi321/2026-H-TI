...
void screen_display(void)
{
	...
	switch(page_number)
	{
		...
		case 30:
		{
			LCD_clear_L(0,0); display_6_8_string(0,0,"PA15 TIMER GATE");
			LCD_clear_L(0,1); display_6_8_string(0,1,"request:");
			                     display_6_8_number(72,1,Timer_Gate_GetRequested());
			LCD_clear_L(0,2); display_6_8_string(0,2,"dout:");
			                     display_6_8_number(72,2,Timer_Gate_GetOutputLatch());
			LCD_clear_L(0,3); display_6_8_string(0,3,"output en:");
			                     display_6_8_number(72,3,Timer_Gate_GetOutputEnabled());
			LCD_clear_L(0,4); display_6_8_string(0,4,"pin level:");
			                     display_6_8_number(72,4,Timer_Gate_GetPinLevel());
			LCD_clear_L(0,5); display_6_8_string(0,5,"unlock:");
			                     display_6_8_number(72,5,trackless_output.unlock_flag);
			LCD_clear_L(0,6); display_6_8_string(0,6,"work mode:");
			                     display_6_8_number(72,6,sdk_work_mode);
			LCD_clear_L(0,7); display_6_8_string(0,7,"page:");
			                     display_6_8_number(110,7,page_number+1);
		}
		break;
		default:
		{
