...
void trackless_params_init(void)
{
  ...
  //平衡控制pid参数
	...
	if(w25qxx_id==W25Q64&&
	   (isnan(tmp_reserved_params[12])||
	    tmp_reserved_params[12]==self_guided_tracking_speed_legacy))
	{
		WriteFlashParameter(RESERVED_PARAMS_13,
			self_guided_tracking_speed,&Trackless_Params);
		ReadFlashParameterOne(RESERVED_PARAMS_13,&tmp_reserved_params[12]);
	}
